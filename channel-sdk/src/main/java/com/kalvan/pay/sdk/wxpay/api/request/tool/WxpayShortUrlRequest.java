...
import com.kalvan.pay.sdk.wxpay.api.response.tool.WxpayShortUrlResponse;
...
/**
 * wxpay shorturl request
 */
@Getter
@Setter
public class WxpayShortUrlRequest implements WxpayRequest<WxpayShortUrlResponse> {
    ...
    @Override
    public Class<WxpayShortUrlResponse> getResponseClass() {
