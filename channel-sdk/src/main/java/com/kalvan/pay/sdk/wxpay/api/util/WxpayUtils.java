...
public class WxpayUtils {
    ...
    public static Logger getLogger() {
        return LoggerFactory.getLogger("« wxpay api »");
    }
     ...
     * @throws Exception
     */
    public static String mapToXml(WxpayHashMap data) throws Exception {
    ...
    public static <T extends Object> T mapToObject(Map<?, ?> map, Class<?> beanClass) throws Exception {
        ...
        for (Field field : childFields) {
            ...
            field.set(obj, map.get(StringUtils.camelToUnderline(field.getName().replace("Info", ""))));
        }
