...
import com.noahpay.pay.payment.settle.service.ReportChannelService;
 ...
 * @author kalvan
 */
@SysLog(group = LogGroup.REPORT_CHANNEL)
@RestController
@RequestMapping("payment/settle/reportchannel")
@Slf4j
public class ReportChannelController extends BaseController {
     ...
     */
    @PostMapping("list")
    @Permission("payment:settle:reportchannel:list")
    public WebResponse list(PageInfo pageInfo, @RequestParam Map<String, Object> params) {
        Page<ReportChannel> data = reportChannelService.queryPage(pageInfo, params);
     ...
     */
    @SysLog(remark = "导出渠道报表", type = LogType.EXPORT)
    @PostMapping("download")
    @Permission("payment:settle:reportchannel:download")
    public void download(@RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        ...
        ExcelUtil.download(filename, response, ReportChannel.class, data, excludeColumnFiledNames);
    }
