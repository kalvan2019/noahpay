...
import com.noahpay.pay.payment.settle.service.MerchantProfitService;
 ...
 * @author kalvan
 */
@SysLog(group = LogGroup.MERCHANT_PROFIT)
@RestController
@RequestMapping("payment/settle/merchantprofit")
@Slf4j
public class MerchantProfitController extends BaseController {
    @Resource
    MerchantProfitService merchantProfitService;
     ...
     */
    @PostMapping("list")
    @Permission("payment:settle:merchantprofit:list")
    public WebResponse list(PageInfo pageInfo, @RequestParam Map<String, Object> params) {
        Page<MerchantProfit> data = merchantProfitService.queryPage(pageInfo, params);
     ...
     */
    @SysLog(remark = "导出商户分润", type = LogType.EXPORT)
    @PostMapping("download")
    @Permission("payment:settle:merchantprofit:download")
    public void download(@RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        ...
        ExcelUtil.download(filename, response, MerchantProfit.class, data, excludeColumnFiledNames);
    }
