...
import com.noahpay.pay.payment.settle.service.PartnerProfitService;
 ...
 * @author kalvan
 */
@SysLog(group = LogGroup.PARTNER_PROFIT)
@RestController
@RequestMapping("payment/settle/partnerprofit")
@Slf4j
public class PartnerProfitController extends BaseController {
    @Resource
    PartnerProfitService partnerProfitService;
     ...
     */
    @PostMapping("list")
    @Permission("payment:settle:partnerprofit:list")
    public WebResponse list(PageInfo pageInfo, @RequestParam Map<String, Object> params) {
        Page<PartnerProfit> data = partnerProfitService.queryPage(pageInfo, params);
     ...
     */
    @SysLog(remark = "导出合作方分润", type = LogType.EXPORT)
    @PostMapping("download")
    @Permission("payment:settle:partnerprofit:download")
    public void download(@RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        ...
        ExcelUtil.download(filename, response, PartnerProfit.class, data, excludeColumnFiledNames);
    }
