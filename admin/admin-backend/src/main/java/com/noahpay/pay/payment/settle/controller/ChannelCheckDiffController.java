...
import com.noahpay.pay.payment.settle.service.ChannelCheckDiffService;
 ...
 * @author kalvan
 */
@SysLog(group = LogGroup.CHANNEL_CHECK_DIFF)
@RestController
@RequestMapping("payment/settle/channelcheckdiff")
@Slf4j
public class ChannelCheckDiffController extends BaseController {
    @Resource
    ChannelCheckDiffService channelCheckDiffService;
     ...
     */
    @PostMapping("list")
    @Permission("payment:settle:channelcheckdiff:list")
    public WebResponse list(PageInfo pageInfo, @RequestParam Map<String, Object> params) {
        Page<ChannelCheckDiff> data = channelCheckDiffService.queryPage(pageInfo, params);
     ...
     */
    @SysLog(remark = "导出对账结果差异明细", type = LogType.EXPORT)
    @PostMapping("download")
    @Permission("payment:settle:channelcheckdiff:download")
    public void download(@RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        ...
        ExcelUtil.download(filename, response, ChannelCheckDiff.class, data, excludeColumnFiledNames);
    }
