...
import com.noahpay.pay.payment.settle.service.AccountSummaryDayService;
 ...
 * @author kalvan
 */
@SysLog(group = LogGroup.ACCOUNT_SUMMARY_DAY)
@RestController
@RequestMapping("payment/settle/accountsummaryday")
@Slf4j
public class AccountSummaryDayController extends BaseController {
    @Resource
    AccountSummaryDayService accountSummaryDayService;
     ...
     */
    @PostMapping("list")
    @Permission("payment:settle:accountsummaryday:list")
    public WebResponse list(PageInfo pageInfo, @RequestParam Map<String, Object> params) {
        Page<AccountSummaryDay> data = accountSummaryDayService.queryPage(pageInfo, params);
     ...
     */
    @SysLog(remark = "导出账户余额日终报表", type = LogType.EXPORT)
    @PostMapping("download")
    @Permission("payment:settle:accountsummaryday:download")
    public void download(@RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        ...
        ExcelUtil.download(filename, response, AccountSummaryDay.class, data, excludeColumnFiledNames);
    }
