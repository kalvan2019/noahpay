...
INSERT INTO `menu` ( `system_code`, `title`, `type`, `icon`, `path`, `code`, `priority`, `parent_id`, `name` )
    SELECT @systemCode,'商户用户银行协议', 'menu', '', '/cust/merchantconsumerprotocol',
        'admin:cust:merchantconsumerprotocol:index', 1, @parentId, 'merchantconsumerprotocol';
...
INSERT INTO `menu` ( `system_code`,`title`, `type`, `icon`, `path`, `code`, `priority`, `parent_id` )
    SELECT @systemCode,'列表', 'button', '', '#',
     'admin:cust:merchantconsumerprotocol:list', 1,@newParentId;
INSERT INTO `menu` ( `system_code`,`title`, `type`, `icon`, `path`, `code`, `priority`, `parent_id` )
    SELECT @systemCode,'下载', 'button', '', '#',
     'admin:cust:merchantconsumerprotocol:download', 1,@newParentId;
