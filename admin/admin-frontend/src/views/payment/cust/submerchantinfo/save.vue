    ...
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="子商户号">
          <a-input v-decorator="['subMerchantNo', {initialValue: model.subMerchantNo,rules: [{ required: true, message: '子商户号不能为空！' }]}]"/>
        </a-form-item>
        <a-form-item label="子商户名">
          <a-input v-decorator="['subMerchantName', {initialValue: model.subMerchantName,rules: [{ required: true, message: '子商户名不能为空！' }]}]"/>
        </a-form-item>
        <a-form-item label="子商户客户号">
          <a-input v-decorator="['custNo', {initialValue: model.custNo,rules: [{ required: true, message: '子商户客户号不能为空！' }]}]"/>
        </a-form-item>
        <a-form-item label="归属商户号">
          <a-input v-decorator="['merchantNo', {initialValue: model.merchantNo,rules: [{ required: true, message: '归属商户号不能为空！' }]}]"/>
        </a-form-item>
        ...
        <a-form-item label="客户状态">
          <a-select
            show-search
            placeholder="请选择"
            v-decorator="['state', {initialValue: model.state,rules:[{ required: true, message: '客户状态不能为空！' }]}]">
...
<script>
  ...
  import { getInfo, addInfo, editInfo } from '@/api/payment/cust/submerchantinfo'
  export default {
    mixins: [detailMixins],
    data () {
      return {
