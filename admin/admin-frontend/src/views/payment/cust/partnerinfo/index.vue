  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div class="table-page-search-wrapper">
        <a-form :form="form" layout="inline">
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="合作方客户号">
                <a-input v-decorator="['custNo',{rules: []}]" placeholder="请输入合作方客户号"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
      ...
      <div class="table-operator">
        <a-button type="primary" icon="download" @click="handleDownload" v-if="hasPerm('payment:cust:partnerinfo:download')">下载</a-button>
        <a-button type="primary" icon="plus" @click="handleAdd" v-if="hasPerm('payment:cust:partnerinfo:add')">新建</a-button>
        <a-button type="primary" icon="download" @click="handleDownloadTemplate" v-if="hasPerm('payment:cust:partnerinfo:upload')">批量导入模板</a-button>
        <a-upload
          name="file"
          :customRequest="handleUpload"
        >
          <a-button type="primary" icon="upload" v-if="hasPerm('payment:cust:partnerinfo:upload')">批量导入</a-button>
        </a-upload>
      </div>
      <!--汇总-->
      <!--数据表格-->
      ...
      >
        ...
        <template v-slot:action="text, record">
          <span>
            <a href="javascript:" @click="handleEdit(record)" v-if="hasPerm('payment:cust:partnerinfo:edit')">编辑</a>
...
<script>
  ...
  import { getList, downloadFile, downloadTemplateFile, uploadFile } from '@/api/payment/cust/partnerinfo'
