  ...
  <page-header-wrapper>
    <a-card :bordered="false">
          ...
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="机构号">
                <a-input v-decorator="['orgNo',{rules: []}]" placeholder="请输入机构号"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="业务类型">
                <a-input v-decorator="['transType',{rules: []}]" placeholder="请输入业务类型"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
      ...
      <div class="table-operator">
        <a-button type="primary" icon="download" @click="handleDownload" v-if="hasPerm('payment:settle:merchantcheckrecord:download')">下载</a-button>
      </div>
      <!--汇总-->
      <!--数据表格-->
      <a-table
...
<script>
  ...
  import { getList, downloadFile } from '@/api/payment/settle/merchantcheckrecord'
  export default {
    mixins: [curdMixins],
    components: {
    },
