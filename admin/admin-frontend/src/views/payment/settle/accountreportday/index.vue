          ...
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="交易类型">
                <a-input v-decorator="['refTransType',{rules: []}]" placeholder="请输入交易类型"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="凭证类型">
                <a-input v-decorator="['voucherType',{rules: []}]" placeholder="请输入凭证类型"/>
              </a-form-item>
            </a-col>
            <a-col :md="12" :sm="24">
...
<script>
  ...
  import { getList } from '@/api/payment/settle/accountreportday'
  export default {
    mixins: [curdMixins],
    components: {
    },
