  ...
  <page-header-wrapper>
    <a-card :bordered="false">
          ...
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="对账结果">
                <a-input v-decorator="['diffState',{rules: []}]" placeholder="请输入对账结果"/>
              </a-form-item>
            </a-col>
            <a-col :md="12" :sm="24">
      ...
      <div class="table-operator">
        <a-button type="primary" icon="download" @click="handleDownload" v-if="hasPerm('payment:settle:channelcheckdiff:download')">下载</a-button>
      </div>
      <!--汇总-->
      <!--数据表格-->
      <a-table
...
<script>
  ...
  import { getList, downloadFile } from '@/api/payment/settle/channelcheckdiff'
  export default {
    mixins: [curdMixins],
    components: {
    },
    data () {
      this.columns = [
        ...
        {
          title: '渠道交易金额',
          dataIndex: 'channelSendAmount'
        },
        {
          title: '渠道返回金额',
          dataIndex: 'channelRecvAmount'
        },
        {
          title: '对账结果',
          dataIndex: 'diffState'
