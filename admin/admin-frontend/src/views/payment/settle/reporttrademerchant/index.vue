  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div class="table-operator">
        <a-button type="primary" icon="download" @click="handleDownload" v-if="hasPerm('payment:settle:reporttrademerchant:download')">下载</a-button>
      </div>
      <!--汇总-->
      <!--数据表格-->
      <a-table
...
<script>
  ...
  import { getList, downloadFile } from '@/api/payment/settle/reporttrademerchant'
  export default {
    mixins: [curdMixins],
    components: {
    },
