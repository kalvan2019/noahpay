    ...
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="渠道行别">
          <a-input v-decorator="['channelBankType', {initialValue: model.channelBankType,rules: [{ required: true, message: '渠道行别不能为空！' }]}]"/>
        </a-form-item>
...
<script>
  ...
  import { getInfo, addInfo, editInfo } from '@/api/payment/channel/channelbanktype'
  export default {
    mixins: [detailMixins],
    data () {
      return {
