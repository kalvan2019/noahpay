 ...
 * @author chenliang
 */
public class TransDayShardingAlgorithm implements ComplexKeysShardingAlgorithm<Integer> {
    @Override
    public Collection<String> doSharding(Collection<String> availableTargetNames, ComplexKeysShardingValue<Integer> complexKeysShardingValue) {
        ...
        Range<Integer> orderDateRange = rangeMap.get("order_date");
